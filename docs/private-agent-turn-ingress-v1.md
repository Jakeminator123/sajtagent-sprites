...
the cursor-bounded `session.message` history projection for the accepted turn
and accepts exactly one matching tool call. The bounded retry covers the small delay between
